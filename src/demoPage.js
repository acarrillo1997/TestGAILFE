    ...
    <div className="bg-white">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
        <div className="flex flex-col items-stretch w-[21%] max-md:w-full max-md:ml-0">
          <div className="bg-slate-100 flex w-full grow flex-col items-stretch mx-auto pl-8 pr-16 py-12 max-md:mt-10 max-md:px-5">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/daee6562-d01d-430d-97d1-a29bc7587f3a?apiKey=4e612c7b4e3e4212bd90c1f2877c00c8&"
              className="aspect-[3.56] object-contain object-center w-[121px] overflow-hidden max-w-full mt-1.5 self-end"
            />
            <div className="flex w-[67px] max-w-full items-stretch gap-1 mt-1.5 self-end">
              <div className="text-orange-600 text-xs font-bold leading-[56px]">
                by
              </div>
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/2492d675-ad83-48d9-b851-7cd24f93de40?apiKey=4e612c7b4e3e4212bd90c1f2877c00c8&"
                className="aspect-[5.89] object-contain object-center w-full justify-center items-center overflow-hidden shrink-0"
              />
            </div>
            <div className="flex items-stretch justify-between gap-4 mt-10 mb-[1102px] max-md:mb-10">
              <div className="flex grow basis-[0%] flex-col items-center">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/f6961a00-53c8-456b-86e7-7a1edba161f9?apiKey=4e612c7b4e3e4212bd90c1f2877c00c8&"
                  className="aspect-[1.83] object-contain object-center w-11 overflow-hidden"
                />
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/dcd45df7-4976-4495-a1a2-51bbea111496?apiKey=4e612c7b4e3e4212bd90c1f2877c00c8&"
                  className="aspect-[1.83] object-contain object-center w-11 overflow-hidden mt-9"
                />
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/f8855062-82c6-431d-a1c4-ae299699e582?apiKey=4e612c7b4e3e4212bd90c1f2877c00c8&"
                  className="aspect-[1.83] object-contain object-center w-11 overflow-hidden mt-8"
                />
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/ff0452b5-b7e4-4b01-90d2-c26bddbddaf8?apiKey=4e612c7b4e3e4212bd90c1f2877c00c8&"
                  className="aspect-[1.83] object-contain object-center w-11 overflow-hidden mt-9"
                />
              </div>
              <div className="text-slate-700 text-base leading-[56px] self-center my-auto">
